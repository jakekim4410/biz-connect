  ...
  ko: {
    ...
    buyer: {
      ...
      confirmed: {
        ...
        noMeetingsDesc: "정해진 필터에 맞는 확정 일정이 아직 없습니다. [예약 관리] 탭에서 신청 내역을 확인해 보세요.",
        countSuffix: "건",
        completed: "Completed",
        confirmed: "Confirmed",
        location: "운영팀 지정 장소",
      ...
      rejected: {
        title: "거절 내역 (REJECTED)",
        countSuffix: "건",
        noMeetings: "거절된 내역이 없습니다.",
        noMeetingsDesc: "취소되었거나 거절된 미팅 신청 내역이 여기에 표시됩니다.",
      },
      generator: {
        title: "상담 가능 슬롯 생성",
    ...
    seller: {
      nav: {
        ...
        mySlots: "내 슬롯 관리",
        slotGenerator: "슬롯 생성",
        receivedRequests: "받은 제안",
        buyerDirectory: "바이어 탐색",
      },
      buyerDirectory: {
        title: "바이어 탐색",
        searchPlaceholder: "회사명, 투자 분야, 담당자 검색...",
        noResults: "검색 조건에 맞는 바이어가 없습니다.",
        requestMeeting: "미팅 제안",
        directRequest: "다이렉트 제안",
      },
      slotManagement: {
        title: "내 슬롯 관리",
        subtitle: "바이어가 신청할 수 있는 나의 상담 슬롯을 관리합니다.",
        noSlots: "개설된 슬롯이 없습니다.",
        noSlotsDesc: "[슬롯 생성] 탭에서 새 슬롯을 만들어 바이어들의 신청을 기다려보세요.",
        pendingFilter: "신청 대기중",
        matchedFilter: "매칭 완료",
        expiredFilter: "기간 만료",
        allFilter: "전체",
        noRequestsOnSlot: "신청 없음",
        reviewBtn: "검토하기",
        editBtn: "수정",
        deleteBtn: "삭제",
        reviewModalTitle: "신청 검토",
        acceptBtn: "수락 (확정)",
        rejectBtn: "거절하기",
      },
      slotGenerator: {
        title: "상담 가능 슬롯 생성",
        subtitle: "바이어가 신청할 수 있는 시간을 새롭게 등록하세요.",
        dateLabel: "상담 희망 일자",
        hourLabel: "시간 (Hour)",
        minuteLabel: "분 (Minute)",
        locationLabel: "상담 장소 / 온라인 여부",
      ...
      receivedRequests: {
        title: "받은 미팅 제안",
        noRequests: "받은 다이렉트 제안이 없습니다.",
        noRequestsDesc: "바이어에게서 직접 미팅 제안이 오면 여기에 표시됩니다.",
        acceptBtn: "수락하기",
        rejectBtn: "거절하기",
        selectSlot: "연결할 내 슬롯 선택",
        noSlotAvailable: "연결 가능한 슬롯이 없습니다. [슬롯 생성] 탭에서 먼저 슬롯을 만드세요.",
        confirmMapping: "이 슬롯으로 확정",
      },
      available: {
        title: "매칭 탐색",
        viewAll: "🔍 전체 목록 보기",
  ...
  en: {
    ...
    buyer: {
      ...
      confirmed: {
        ...
        noMeetingsDesc: "There are no confirmed meetings matching the filters. Check your applications in the [Reservations] tab.",
        countSuffix: "Meetings",
        completed: "Completed",
        confirmed: "Confirmed",
      ...
      rejected: {
        ...
        countSuffix: "Meetings",
        noMeetings: "No rejected meetings found.",
        noMeetingsDesc: "Meetings that were cancelled or rejected will appear here.",
      },
      generator: {
    ...
    seller: {
      nav: {
        ...
        mySlots: "My Slots",
        slotGenerator: "Create Slot",
        receivedRequests: "Received Proposals",
        buyerDirectory: "Buyer Directory",
      },
      buyerDirectory: {
        title: "Buyer Directory",
        searchPlaceholder: "Search by company, investment focus, contact...",
        noResults: "No buyers found matching your criteria.",
        requestMeeting: "Request Meeting",
        directRequest: "Direct Proposal",
      },
      slotManagement: {
        title: "My Slot Management",
        subtitle: "Manage your consultation slots for buyers to apply.",
        noSlots: "No slots created yet.",
        noSlotsDesc: "Create a new slot in the [Create Slot] tab and wait for buyer applications.",
        pendingFilter: "Pending",
        matchedFilter: "Matched",
        expiredFilter: "Expired",
        allFilter: "All",
        noRequestsOnSlot: "No requests",
        reviewBtn: "Review",
        editBtn: "Edit",
        deleteBtn: "Delete",
        reviewModalTitle: "Review Application",
        acceptBtn: "Accept (Confirm)",
        rejectBtn: "Reject",
      },
      slotGenerator: {
        title: "Create Consultation Slot",
        subtitle: "Add a new time slot for buyers to apply.",
        dateLabel: "Preferred Date",
        hourLabel: "Hour",
        minuteLabel: "Minute",
        locationLabel: "Location / Online",
      ...
      receivedRequests: {
        title: "Received Meeting Proposals",
        noRequests: "No direct proposals received.",
        noRequestsDesc: "Direct meeting proposals from buyers will appear here.",
        acceptBtn: "Accept",
        rejectBtn: "Reject",
        selectSlot: "Select slot to link",
        noSlotAvailable: "No available slots. Create one in [Create Slot] tab first.",
        confirmMapping: "Confirm with this slot",
      },
      available: {
        title: "Match Explore",
        viewAll: "🔍 View All",
